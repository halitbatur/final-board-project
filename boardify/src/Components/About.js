  ...
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        ...
        <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
                <img className=" grayscale hover:grayscale-0 transition mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/helene-engels.png" alt="Helene Avatar"/>
                <h3 className="mb-1 text-2xl font-bold tracking-tight text-[#2f2f2f]">
                    <a href="#">Banel Mikhael</a>
                </h3>
                <p className="text-[#6c6c6c]">Front-end Developer</p>
                <ul className="flex justify-center mt-4 space-x-4">
                    <li>
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
                <img className=" grayscale hover:grayscale-0 transition  mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png" alt="Jese Avatar"/>
                <h3 className="mb-1 text-2xl font-bold tracking-tight text-[#2f2f2f]">
                    <a href="#">Hevar Tofiq</a>
                </h3>
                <p className="text-[#6c6c6c]">Front-End Developer</p>
                <ul className="flex justify-center mt-4 space-x-4">
                    <li>
