      ...
      {showForm ?
        (< form onSubmit={() => handleTaskSubmit(task)}
          ...
          <div className="mt-2">
            ...
            <input className="border-2 w-32 h-20 pl-2 md:w-40 border-black placeholder:italic placeholder:pl-0.5
            align-text-bottom align-top" type="text" placeholder="enter a description"
              onChange={handleTaskChange}
          ...
          <input className="border-2 border-black mt-4 w-20 bg-black text-white hover:bg-red-800
          ...
          <button onClick={() => setShowForm(false)} className="border-2 border-black mt-4 md:ml-4 w-16 bg-black text-white
            hover:cursor-pointer hover:text-white hover:bg-red-800 hover:border-red-800">Cancel</button>
        </form>

        ) : (
          <button onClick={handleAddNewEmptyTask} className="border-2 border-black my-4 w-full bg-black text-white font-bold p-2 hover:bg-white
